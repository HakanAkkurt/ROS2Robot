...
def generate_launch_description():
    ...
    # Resource path setup for Gazebo
    env_model_path = str(Path(bumperbot_description).parent.resolve())
    env_model_path += pathsep + os.path.join(get_package_share_directory("bumperbot_description"), 'models')
